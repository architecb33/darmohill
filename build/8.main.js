    ...
    function CustomPage(navParams, nav, modalCtrl, renderer, elementRef, viewCtrl, platform, translate, storage, events, toastCtrl, headerLogoService) {
        ...
        this.inputData = {
            ...
            openPageBack: function (page) {
                ...
                if (page.type === 'apppages' && page.page_type === 'list') {
                    _this.nav.setRoot('PostList', page, { animate: true, direction: 'back' });
                }
                else if (page.type === 'apppages') {
                    _this.nav.setRoot('CustomPage', page, { animate: true, direction: 'back' });
                }
                else if (page.url) {
                    _this.nav.setRoot('Iframe', page, { animate: true, direction: 'back' });
                }
                else {
                    _this.nav.setRoot(page.component, page.navparams);
                }
